(function() {
  ...
  var formatDouble = d3.format("02d"),
      formatSeconds = function(d) { return Math.round(d / 10000) + " min"; }
  ...
  function renderMovie(movieData, i) {
    ...
    var sections = [
      {label: "Full attention", ms: sectionDuration},
      {label: "Partial attention", ms: sectionDuration * 2},
      {label: "Boring", ms: sectionDuration * 3}
    ];
    ...
    var color = d3.scale.threshold()
        ...
        .range(["#ccc","#07FF00", "#FFD500", "#FF0000"]);
