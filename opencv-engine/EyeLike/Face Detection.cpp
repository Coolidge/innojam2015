...
//			cascade = static_cast<CvHaarClassifierCascade* >(cvLoad( CascadeFile));
//
//
//			// (2) Defining the path and Loading the Classifier in (C++ format)
//			string RootCascade = "MyCascade/";
//			string Extension = ".xml";
//			auto filename = RootCascade + "haarcascade_frontalface_alt2" + Extension;
//			cascade = static_cast<CvHaarClassifierCascade* >(cvLoad( filename.c_str()));
//
//
//						
//			// (3)  Creating Buffer
...
//void detectFaces( IplImage *newframe)
//        {
//	        auto faces = cvHaarDetectObjects( newframe, cascade, storage,
//												1.15, 5, 
...
//
//			for(auto i = 0 ; i < ( faces ? faces->total : 0 ) ; i++ )
//				{
//					auto r = reinterpret_cast<CvRect *>(cvGetSeqElem( faces, i ));
//					
